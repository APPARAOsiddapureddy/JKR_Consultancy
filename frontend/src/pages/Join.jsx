...
const Join = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#0f172a] px-4 py-10 overflow-hidden relative">
      {/* Background image - using a better parliament or constitution related image */}
      <div 
      ...
      <motion.button
        ...
        onClick={() => navigate(-1)}
        className="absolute top-6 left-6 flex items-center gap-2 bg-[#3b82f6] hover:bg-[#2563eb] px-4 py-2 rounded-lg z-10 text-white font-bold shadow-lg"
      ...
      >
        <h1 className="text-5xl font-bold text-white mb-2">JOIN WITH US</h1>
        <div className="h-1 w-32 bg-[#60a5fa] mx-auto mb-2"></div>
      </motion.div>
