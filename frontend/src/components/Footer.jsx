...
const Footer = () => {
  ...
  const serviceLinks = [
    ...
    { to: "/services/campaign", label: "Campaign Management" },
    { to: "/services/data-policies", label: "Data-Driven Policies" },
    { to: "/services/volunteer", label: "Volunteer Platforms" },
    { to: "/services/door-campaign", label: "Door-to-Door Campaigns" }
  ];
